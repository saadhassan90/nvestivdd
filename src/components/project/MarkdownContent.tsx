...
export function MarkdownContent({ content }: MarkdownContentProps) {
  return (
    <div className="prose prose-sm max-w-none
      ...
      prose-table:text-[12px] prose-table:border-separate prose-table:border-spacing-0
      prose-thead:bg-muted/50
      prose-th:text-foreground prose-th:font-semibold prose-th:text-[11px] prose-th:uppercase prose-th:tracking-wider
      prose-th:px-3 prose-th:py-2 prose-th:border prose-th:border-border prose-th:text-left
