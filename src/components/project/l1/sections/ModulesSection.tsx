    ...
    <Card className="overflow-hidden" commentId={`module-${m.key}`} commentLabel={MODULE_LABEL[m.key]}>
      ...
      {open && (
        <div className="border-t border-border/60 px-4 py-4 space-y-4 bg-background/40">
          ...
          {m.facts.length > 0 && (
            <div>
              <p className="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground mb-2">Facts</p>
          ...
          {m.flag_refs.length > 0 && (
            <div>
              <p className="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground mb-1.5">Related flags</p>
